...
public:
    ...
    static  vector<float> compute_p_value(vector<boost::numeric::ublas::matrix_column<boost_matrix>> const& pattern_datas, boost_vector_int const& _phenos_vector, unsigned pattern_size);
