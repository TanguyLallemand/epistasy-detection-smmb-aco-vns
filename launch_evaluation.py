...
os.system('./evaluation/eval_simu.py -i ./data_simulated_from_class/simu_naive/Simu_naive/Simu_naive_3snp_0.75/ -o ./evaluation/result_eval/ -n 100 -m vns -nf 100 -l X')
